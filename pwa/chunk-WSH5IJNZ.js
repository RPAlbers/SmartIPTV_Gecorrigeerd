...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfirmDialogComponent, { className: "ConfirmDialogComponent", filePath: "src\\app\\shared\\components\\confirm-dialog\\confirm-dialog.component.ts", lineNumber: 26 });
})();
...
var PlaylistInfoComponent = class _PlaylistInfoComponent {
  constructor(datePipe, formBuilder, playlistsService, playlistData, store, databaseService, snackBar) {
  ...
  saveChanges(playlist) {
    return __async(this, null, function* () {
      try {
        if (this.playlist && this.playlist.username && this.playlist.password && this.playlist.serverUrl) {
        ...
        this.snackBar.open("Playlist details updated successfully", "Close", { duration: 3e3 });
      } catch (error) {
  ...
  static {
    ...
    }, dependencies: [TranslateModule, TranslatePipe, MatButtonModule, MatButton, MatIconModule, MatIcon, MatInputModule, MatInput, MatFormField, MatLabel, MatHint, MatCheckboxModule, MatCheckbox, CommonModule, NgIf, ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, MatDialogModule, MatDialogClose, MatDialogTitle, MatDialogActions, MatDialogContent], styles: ["\n\n.spacer[_ngcontent-%COMP%] {\n  flex: 1 1 auto;\n}"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaylistInfoComponent, { className: "PlaylistInfoComponent", filePath: "src\\app\\home\\recent-playlists\\playlist-info\\playlist-info.component.ts", lineNumber: 51 });
})();
