import {
  SettingsComponent
} from "./chunk-ZZJMYIWV.js";
import "./chunk-5OOBV4TS.js";
import {
  EpgService
} from "./chunk-HKYBYYWS.js";
import {
  MatToolbar,
  MatToolbarModule
} from "./chunk-ARXSO5EQ.js";
import "./chunk-CVAVMGUJ.js";
import "./chunk-OFWQSLAY.js";
import "./chunk-RRCJMUS5.js";
import "./chunk-SIRA6WMX.js";
import {
  EpgItemDescriptionComponent
} from "./chunk-SYEL4F3B.js";
import {
  ArtPlayerComponent,
  DPlayerComponent,
  HtmlVideoPlayerComponent,
  VjsPlayerComponent
} from "./chunk-QUUTD2CT.js";
import {
  SettingsStore
...
var MatDrawer = class _MatDrawer {
  ...
  constructor(_elementRef, _focusTrapFactory, _focusMonitor, _platform, _ngZone, _interactivityChecker, _doc, _container) {
    ...
    this._animationEnd.pipe(distinctUntilChanged((x2, y3) => {
      return x2.fromState === y3.fromState && x2.toState === y3.toState;
    })).subscribe((event) => {
      const {
        fromState,
        toState
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AudioPlayerComponent, { className: "AudioPlayerComponent", filePath: "src\\app\\player\\components\\audio-player\\audio-player.component.ts", lineNumber: 89 });
})();
...
var MomentDatePipe = class _MomentDatePipe {
  ...
  static {
    this.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({ name: "momentDate", type: _MomentDatePipe, pure: true, standalone: true });
  }
};
...
var EpgListItemComponent = class _EpgListItemComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EpgListItemComponent, selectors: [["app-epg-list-item"]], inputs: { item: "item", timeNow: "timeNow", timeshiftUntil: "timeshiftUntil" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 8, vars: 13, consts: [[1, "time"], [1, "live", "badge", 3, "matTooltip"], [1, "rec", "badge", 3, "matTooltip"], ["matListItemMeta", "", 1, "description-icon", 3, "click", "matTooltip"]], template: function EpgListItemComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275text(4, "\n");
        \u0275\u0275template(5, EpgListItemComponent_Conditional_5_Template, 5, 3)(6, EpgListItemComponent_Conditional_6_Template, 5, 3)(7, EpgListItemComponent_Conditional_7_Template, 6, 3);
      }
      if (rf & 2) {
        \u0275\u0275advance();
    ...
    }, dependencies: [MomentDatePipe, MatIconModule, MatIcon, MatTooltipModule, MatTooltip, TranslateModule, TranslatePipe], styles: ["\n\n.time[_ngcontent-%COMP%] {\n  color: #666;\n  border-bottom: 1px solid #ccc;\n  font-size: 0.8em;\n  display: inline-block;\n  margin-bottom: 5px;\n}\n.badge[_ngcontent-%COMP%] {\n  border-radius: 2px;\n  padding: 2px 6px;\n  color: #fff;\n  text-transform: uppercase;\n  margin-left: 6px;\n  font-size: 0.8em;\n}\n.live[_ngcontent-%COMP%] {\n  background-color: red;\n}\n.rec[_ngcontent-%COMP%] {\n  background-color: grey;\n}\n.description-icon[_ngcontent-%COMP%] {\n  float: right;\n  cursor: pointer;\n}"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EpgListItemComponent, { className: "EpgListItemComponent", filePath: "src\\app\\player\\components\\epg-list\\epg-list-item\\epg-list-item.component.ts", lineNumber: 17 });
})();
...
function EpgListComponent_Conditional_52_Conditional_4_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, "\n                ");
    \u0275\u0275template(1, EpgListComponent_Conditional_52_Conditional_4_For_2_Conditional_1_Template, 12, 4)(2, EpgListComponent_Conditional_52_Conditional_4_For_2_Conditional_2_Template, 11, 7);
...
function EpgListComponent_Conditional_52_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "\n        ");
    \u0275\u0275template(4, EpgListComponent_Conditional_52_Conditional_4_Template, 3, 0)(5, EpgListComponent_Conditional_52_Conditional_5_Template, 5, 3);
    \u0275\u0275elementEnd();
    \u0275\u0275text(6, "\n");
  }
  if (rf & 2) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EpgListComponent, selectors: [["app-epg-list"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 53, vars: 23, consts: [["id", "channel-header", "color", "primary"], [1, "channel-info"], [1, "channel-icon"], [1, "channel-details"], [1, "channel-name"], [1, "program-name"], ["id", "date-navigator"], ["mat-icon-button", "", 1, "previous-day", 3, "click", "matTooltip"], [1, "selected-date"], ["mat-icon-button", "", 1, "next-day", 3, "click", "matTooltip"], ["width", "48", 3, "src"], ["id", "program-list", "hideSingleSelectionIndicator", "true", 3, "multiple"], ["matListItemLine", ""], [3, "timeshiftUntil", "timeNow", "item"], [3, "click", "value"], ["matListItemLine", "", 3, "innerHTML"], [1, "epg-not-available"]], template: function EpgListComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(12, "\n            ");
        \u0275\u0275template(13, EpgListComponent_Conditional_13_Template, 3, 1);
        \u0275\u0275elementEnd();
        \u0275\u0275text(14, "\n        ");
        ...
        \u0275\u0275text(51, "\n\n");
        \u0275\u0275template(52, EpgListComponent_Conditional_52_Template, 7, 2);
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EpgListComponent, { className: "EpgListComponent", filePath: "src\\app\\player\\components\\epg-list\\epg-list.component.ts", lineNumber: 53 });
})();
...
var InfoOverlayComponent = class _InfoOverlayComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InfoOverlayComponent, selectors: [["app-info-overlay"]], inputs: { channel: "channel", epgProgram: "epgProgram" }, standalone: true, features: [\u0275\u0275NgOnChangesFeature, \u0275\u0275StandaloneFeature], decls: 1, vars: 1, consts: [[1, "channel-overlay"], [1, "channel-logo"], ["width", "68", "onerror", "this.style.display='none'", 3, "src"], [1, "content"], [1, "program-name"], [1, "program-description"], [1, "program-progress"], [1, "program-finished", 3, "ngStyle"], [1, "duration"]], template: function InfoOverlayComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, InfoOverlayComponent_Conditional_0_Template, 28, 21);
      }
      if (rf & 2) {
        \u0275\u0275conditional(ctx.channel && ctx.epgProgram ? 0 : -1);
      }
    }, dependencies: [MomentDatePipe, NgStyle], styles: ["\n\n.channel-overlay[_ngcontent-%COMP%] {\n  position: absolute;\n  bottom: 35px;\n  width: 100%;\n  min-height: 130px;\n  max-height: 165px;\n  margin-left: auto;\n  margin-right: auto;\n  left: 0;\n  right: 0;\n  backdrop-filter: blur(10px);\n  flex-direction: row;\n  box-sizing: border-box;\n  display: flex;\n}\n.program-name[_ngcontent-%COMP%], \n.program-description[_ngcontent-%COMP%] {\n  margin: 20px 0;\n  display: -webkit-box;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.channel-logo[_ngcontent-%COMP%] {\n  margin-top: 20px;\n  place-content: flex-start center;\n  align-items: flex-start;\n  flex-direction: row;\n  box-sizing: border-box;\n  display: flex;\n  flex: 1 1 100px;\n  max-width: 100px;\n  min-width: 100px;\n}\n.content[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.program-progress[_ngcontent-%COMP%] {\n  width: 96%;\n  background: #ccc;\n  height: 20px;\n  margin-bottom: 8px;\n}\n.program-name[_ngcontent-%COMP%] {\n  width: 96%;\n  max-height: 20px;\n  -webkit-line-clamp: 1;\n}\n.program-description[_ngcontent-%COMP%] {\n  width: 96%;\n  max-height: 55px;\n  -webkit-line-clamp: 3;\n}\n.program-finished[_ngcontent-%COMP%] {\n  background: #717171;\n  height: 20px;\n  font-size: 0.8em;\n  padding-left: 10px;\n  color: #000;\n  line-height: 20px;\n}\n.duration[_ngcontent-%COMP%] {\n  position: relative;\n  top: -18px;\n  font-size: 0.8em;\n  color: #000;\n  left: 10px;\n}\n.visible[_ngcontent-%COMP%] {\n  visibility: visible;\n  opacity: 1;\n}\n.hidden[_ngcontent-%COMP%] {\n  visibility: hidden;\n  opacity: 0;\n  transition: visibility 0s 2s, opacity 2s linear;\n}"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InfoOverlayComponent, { className: "InfoOverlayComponent", filePath: "src\\app\\player\\components\\info-overlay\\info-overlay.component.ts", lineNumber: 15 });
})();
...
function MultiEpgContainerComponent__svg_g_63_img_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 20);
  }
  if (rf & 2) {
...
function MultiEpgContainerComponent__svg_g_63_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(5, "rect", 16);
    \u0275\u0275text(6, "\n                ");
    \u0275\u0275elementStart(7, "foreignObject", 17);
    \u0275\u0275text(8, "\n                    ");
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(9, "div", 18);
    \u0275\u0275text(10, "\n                        ");
    \u0275\u0275template(11, MultiEpgContainerComponent__svg_g_63_img_11_Template, 1, 2, "img", 19);
    \u0275\u0275text(12, "\n                        ");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275attribute("height", ctx_r3.barHeight)("y", ctx_r3.barHeight * i_r3 + ctx_r3.barHeight);
    \u0275\u0275advance(2);
    \u0275\u0275attribute("height", ctx_r3.barHeight)("y", ctx_r3.barHeight * i_r3 + ctx_r3.barHeight);
    \u0275\u0275advance(4);
...
function MultiEpgContainerComponent__svg_g_73_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "g");
    \u0275\u0275text(1, "\n                ");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275attribute("width", \u0275\u0275pipeBind1(3, 6, ctx_r3.hourWidth$))("height", ctx_r3.barHeight)("x", hour_r5 * \u0275\u0275pipeBind1(4, 8, ctx_r3.hourWidth$));
    \u0275\u0275advance(4);
    \u0275\u0275attribute("x", hour_r5 * \u0275\u0275pipeBind1(7, 10, ctx_r3.hourWidth$));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("\n                    ", hour_r5, ":00\n                ");
  }
}
function MultiEpgContainerComponent__svg_g_76__svg_g_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "g", 24);
    \u0275\u0275listener("click", function MultiEpgContainerComponent__svg_g_76__svg_g_2_Template_g_click_0_listener() {
    ...
    \u0275\u0275element(2, "rect", 25);
    \u0275\u0275text(3, "\n                    ");
    \u0275\u0275elementStart(4, "foreignObject");
    \u0275\u0275text(5, "\n                        ");
    \u0275\u0275namespaceHTML();
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275attribute("transform", "translate(" + program_r7.startPosition + "," + (ctx_r3.barHeight * i_r8 + ctx_r3.barHeight) + ")");
    \u0275\u0275advance(2);
...
function MultiEpgContainerComponent__svg_g_76_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "g");
    \u0275\u0275text(1, "\n                ");
    \u0275\u0275template(2, MultiEpgContainerComponent__svg_g_76__svg_g_2_Template, 10, 7, "g", 23);
    \u0275\u0275text(3, "\n            ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", item_r9.programs)("ngForTrackBy", ctx_r3.trackByProgram);
  }
}
var MultiEpgContainerComponent = class _MultiEpgContainerComponent {
  ...
  requestPrograms() {
    return __async(this, null, function* () {
      ...
      try {
        const channelNames = this._playlistChannels.map((channel) => channel.tvg?.id?.trim() ?? channel.name?.trim() ?? "").filter((name) => name !== "");
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MultiEpgContainerComponent, selectors: [["app-multi-epg-container"]], viewQuery: function MultiEpgContainerComponent_Query(rf, ctx) {
    ...
    }, inputs: { playlistChannels: "playlistChannels" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 86, vars: 43, consts: [["epgContainer", ""], ["id", "epg-navigation"], ["mat-button", "", "color", "accent", 3, "click", "matTooltip"], ["mat-icon-button", "", 3, "click", "matTooltip"], [1, "today-date"], ["mat-icon-button", "", 3, "click", "disabled"], [1, "navigation-buttons"], ["mat-button", "", "matTooltip", "Previous channels", 3, "click", "disabled"], ["mat-button", "", "matTooltip", "Next channels", 3, "click", "disabled"], [1, "parent"], ["id", "channels-column"], [4, "ngFor", "ngForOf", "ngForTrackBy"], ["id", "epg-container"], ["height", "100%", "id", "epg-svg"], ["y1", "0", "stroke", "red", "stroke-width", "2"], [1, "channel"], ["width", "100", "stroke", "black"], ["width", "100"], [1, "channel-name"], ["style", "height: 20px; width: 20px; margin-right: 8px;", 3, "src", "alt", 4, "ngIf"], [2, "height", "20px", "width", "20px", "margin-right", "8px", 3, "src", "alt"], ["fill", "#000", 3, "matTooltip"], ["y", "10", "font-size", "14", "fill", "white", "transform", "translate(20,20)"], ["class", "program", 3, "click", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "program", 3, "click"], [3, "matTooltip"], [1, "program-title"]], template: function MultiEpgContainerComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        \u0275\u0275elementStart(0, "div", 1);
        \u0275\u0275text(1, "\n    ");
        ...
        \u0275\u0275text(62, "\n        ");
        \u0275\u0275template(63, MultiEpgContainerComponent__svg_g_63_Template, 19, 6, "g", 11);
        \u0275\u0275pipe(64, "async");
        \u0275\u0275text(65, "\n    ");
        \u0275\u0275elementEnd();
        \u0275\u0275text(66, "\n    ");
        ...
        \u0275\u0275text(68, "\n        ");
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(69, "svg", 13);
        \u0275\u0275pipe(70, "async");
        \u0275\u0275text(71, "\n            ");
        \u0275\u0275text(72, "\n            ");
        \u0275\u0275template(73, MultiEpgContainerComponent__svg_g_73_Template, 10, 12, "g", 11);
        \u0275\u0275text(74, "\n\n            ");
        \u0275\u0275text(75, "\n            ");
        \u0275\u0275template(76, MultiEpgContainerComponent__svg_g_76_Template, 4, 2, "g", 11);
        \u0275\u0275pipe(77, "async");
        \u0275\u0275text(78, "\n\n            ");
        \u0275\u0275text(79, "\n            ");
        \u0275\u0275element(80, "line", 14);
        \u0275\u0275pipe(81, "async");
        \u0275\u0275text(82, "\n        ");
        \u0275\u0275elementEnd();
        \u0275\u0275text(83, "\n    ");
      ...
      if (rf & 2) {
        let tmp_19_0;
        \u0275\u0275advance(2);
        \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(3, 19, "CLOSE"));
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(8, 21, "CLOSE"), "\n    ");
        \u0275\u0275advance(3);
        \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(11, 23, "EPG.NEXT_DAY"));
        \u0275\u0275advance(7);
        \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(18, 25, "EPG.PREVIOUS_DAY"));
        \u0275\u0275advance(8);
        \u0275\u0275textInterpolate1("\n        ", \u0275\u0275pipeBind3(26, 27, ctx.today, "YYYYMMDD", "MMMM Do, dddd"), "\n    ");
        \u0275\u0275advance(3);
        \u0275\u0275property("disabled", \u0275\u0275pipeBind1(29, 31, ctx.hourWidth$) >= 800);
        \u0275\u0275advance(7);
        \u0275\u0275property("disabled", \u0275\u0275pipeBind1(36, 33, ctx.hourWidth$) <= 50);
        \u0275\u0275advance(9);
        \u0275\u0275property("disabled", ctx.channelsLowerRange === 0);
        \u0275\u0275advance(6);
        \u0275\u0275property("disabled", ctx.isLastPage);
        \u0275\u0275advance(13);
        \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(64, 35, ctx.channels$))("ngForTrackBy", ctx.trackByIndex);
        \u0275\u0275advance(6);
        \u0275\u0275attribute("width", \u0275\u0275pipeBind1(70, 37, ctx.hourWidth$) * 24);
        \u0275\u0275advance(4);
        \u0275\u0275property("ngForOf", ctx.timeHeader)("ngForTrackBy", ctx.trackByIndex);
        \u0275\u0275advance(3);
        \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(77, 39, ctx.channels$))("ngForTrackBy", ctx.trackByIndex);
        \u0275\u0275advance(4);
        \u0275\u0275attribute("x1", ctx.currentTimeLine)("x2", ctx.currentTimeLine)("y2", ((tmp_19_0 = \u0275\u0275pipeBind1(81, 41, ctx.channels$)) == null ? null : tmp_19_0.length) * ctx.barHeight + ctx.barHeight);
      }
    }, dependencies: [
      CommonModule,
      NgForOf,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MultiEpgContainerComponent, { className: "MultiEpgContainerComponent", filePath: "src\\app\\player\\components\\multi-epg\\multi-epg-container.component.ts", lineNumber: 56 });
})();
...
function ToolbarComponent_Conditional_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("\n                ", \u0275\u0275pipeBind1(6, 4, ctx_r2.favorites$).includes(ctx_r2.activeChannel == null ? null : ctx_r2.activeChannel.id) ? "star" : "star_outline", "");
  }
}
...
var ToolbarComponent = class _ToolbarComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ToolbarComponent, selectors: [["app-toolbar"]], inputs: { activeChannel: "activeChannel" }, outputs: { multiEpgClicked: "multiEpgClicked", toggleLeftDrawerClicked: "toggleLeftDrawerClicked", toggleRightDrawerClicked: "toggleRightDrawerClicked" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 33, vars: 16, consts: [["color", "primary"], ["mat-icon-button", "", 1, "sidenav-toggle-button", 3, "click", "matTooltip"], [1, "spacer"], ["mat-icon-button", "", 3, "click", "matTooltip"], ["mat-button", "", 3, "click", "matTooltip"]], template: function ToolbarComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275text(8, "\n    ");
        \u0275\u0275template(9, ToolbarComponent_Conditional_9_Template, 9, 6);
        \u0275\u0275pipe(10, "async");
        \u0275\u0275text(11);
        \u0275\u0275element(12, "div", 2);
        \u0275\u0275text(13, "\n    ");
        ...
        \u0275\u0275pipe(29, "async");
        \u0275\u0275text(30, "\n    ");
        \u0275\u0275template(31, ToolbarComponent_Conditional_31_Template, 5, 3);
        \u0275\u0275elementEnd();
        \u0275\u0275text(32, "\n");
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ToolbarComponent, { className: "ToolbarComponent", filePath: "src\\app\\player\\components\\video-player\\toolbar\\toolbar.component.ts", lineNumber: 35 });
})();

// src/app/player/components/video-player/video-player.component.ts
var VideoPlayerComponent_Defer_9_DepsFn = () => [AsyncPipe, import("./chunk-HN3QLMOH.js").then((m3) => m3.SidebarComponent)];
...
function VideoPlayerComponent_ng_container_14_ng_template_7_app_d_player_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-d-player", 17);
  }
  if (rf & 2) {
    const activeChannel_r5 = \u0275\u0275nextContext(2).ngIf;
    const ctx_r0 = \u0275\u0275nextContext();
...
function VideoPlayerComponent_ng_container_14_ng_template_7_app_art_player_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-art-player", 17);
  }
  if (rf & 2) {
    const activeChannel_r5 = \u0275\u0275nextContext(2).ngIf;
    const ctx_r0 = \u0275\u0275nextContext();
...
function VideoPlayerComponent_ng_container_14_ng_template_7_div_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275listener("click", function VideoPlayerComponent_ng_container_14_ng_template_7_div_13_Template_a_click_6_listener() {
      \u0275\u0275restoreView(_r6);
...
function VideoPlayerComponent_ng_container_14_ng_template_7_div_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 18);
    \u0275\u0275text(1, "\n                    ");
    \u0275\u0275element(2, "img", 19);
...
function VideoPlayerComponent_ng_container_14_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "\n\n                ");
    \u0275\u0275text(4, "\n                ");
    \u0275\u0275template(5, VideoPlayerComponent_ng_container_14_ng_template_7_app_html_video_player_5_Template, 1, 3, "app-html-video-player", 13);
    \u0275\u0275text(6, "\n\n                ");
    \u0275\u0275text(7, "\n                ");
    \u0275\u0275template(8, VideoPlayerComponent_ng_container_14_ng_template_7_app_d_player_8_Template, 1, 3, "app-d-player", 13);
    \u0275\u0275text(9, "\n\n                ");
    \u0275\u0275text(10, "\n                ");
    \u0275\u0275template(11, VideoPlayerComponent_ng_container_14_ng_template_7_app_art_player_11_Template, 1, 3, "app-art-player", 13);
    \u0275\u0275text(12, "\n\n                ");
    \u0275\u0275template(13, VideoPlayerComponent_ng_container_14_ng_template_7_div_13_Template, 10, 0, "div", 14);
    \u0275\u0275text(14, "\n                ");
    \u0275\u0275template(15, VideoPlayerComponent_ng_container_14_ng_template_7_div_15_Template, 7, 0, "div", 14);
    \u0275\u0275text(16, "\n                ");
    \u0275\u0275text(17, "\n                ");
    \u0275\u0275element(18, "app-info-overlay", 15);
    \u0275\u0275pipe(19, "async");
    \u0275\u0275text(20, "\n            ");
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r0.playerSettings.player === "dplayer");
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r0.playerSettings.player === "artplayer");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r0.playerSettings.player === "mpv");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r0.playerSettings.player === "vlc");
    \u0275\u0275advance(3);
    \u0275\u0275property("channel", activeChannel_r5)("epgProgram", \u0275\u0275pipeBind1(19, 8, ctx_r0.epgProgram$));
  }
}
function VideoPlayerComponent_ng_container_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6, "\n            ");
    \u0275\u0275template(7, VideoPlayerComponent_ng_container_14_ng_template_7_Template, 21, 10, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275text(9, "\n        ");
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
var VideoPlayerComponent = class _VideoPlayerComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VideoPlayerComponent, selectors: [["ng-component"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 26, vars: 4, consts: [["drawer", ""], ["drawerRight", ""], ["videoPlayer", ""], [1, "main-container"], ["mode", "side", "opened", "", "disableClose", "", 1, "mat-drawer"], [1, "drawer-content"], [4, "ngIf"], ["position", "end", "mode", "side", "disableClose", ""], [3, "channels"], [3, "toggleLeftDrawerClicked", "toggleRightDrawerClicked", "multiEpgClicked", "activeChannel"], [3, "url", "icon", 4, "ngIf", "ngIfElse"], [3, "url", "icon"], [3, "options", "volume", "hide-captions", 4, "ngIf"], [3, "channel", "volume", "showCaptions", 4, "ngIf"], ["class", "custom-player", 4, "ngIf"], [3, "channel", "epgProgram"], [3, "options", "volume"], [3, "channel", "volume", "showCaptions"], [1, "custom-player"], ["src", "./assets/images/custom-player.png"], [2, "cursor", "pointer", 3, "click", "routerLink"]], template: function VideoPlayerComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VideoPlayerComponent, { className: "VideoPlayerComponent", filePath: "src\\app\\player\\components\\video-player\\video-player.component.ts", lineNumber: 77 });
})();
export {
