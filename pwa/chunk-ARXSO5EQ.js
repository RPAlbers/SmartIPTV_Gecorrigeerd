...
function HeaderComponent_div_16_button_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 17);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function HeaderComponent_div_16_button_17_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
...
function HeaderComponent_div_16_For_29_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275text(0, "\n                    ");
    \u0275\u0275elementStart(1, "p");
    \u0275\u0275text(2, "\n                        ");
    \u0275\u0275elementStart(3, "mat-checkbox", 18);
    \u0275\u0275listener("click", function HeaderComponent_div_16_For_29_Template_mat_checkbox_click_3_listener($event) {
      \u0275\u0275restoreView(_r4);
      return \u0275\u0275resetView($event.stopPropagation());
    })("change", function HeaderComponent_div_16_For_29_Template_mat_checkbox_change_3_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.onPlaylistFilterChange());
    });
    \u0275\u0275twoWayListener("ngModelChange", function HeaderComponent_div_16_For_29_Template_mat_checkbox_ngModelChange_3_listener($event) {
...
function HeaderComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(14, "filter_list");
    \u0275\u0275elementEnd();
    \u0275\u0275text(15, "\n        ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(16, "\n        ");
    \u0275\u0275template(17, HeaderComponent_div_16_button_17_Template, 6, 3, "button", 14);
    \u0275\u0275text(18, "\n\n        ");
    \u0275\u0275elementStart(19, "mat-menu", null, 1);
    \u0275\u0275text(21, "\n            ");
    \u0275\u0275elementStart(22, "section", 15);
    \u0275\u0275listener("click", function HeaderComponent_div_16_Template_section_click_22_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275text(23, "\n                ");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(27, "\n                ");
    \u0275\u0275repeaterCreate(28, HeaderComponent_div_16_For_29_Template, 7, 3, null, null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
    \u0275\u0275text(30, "\n        ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(31, "\n\n        ");
    ...
    \u0275\u0275pipe(47, "translate");
    \u0275\u0275listener("click", function HeaderComponent_div_16_Template_button_click_46_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(56, "\n\n            ");
    \u0275\u0275elementStart(57, "button", 16);
    \u0275\u0275pipe(58, "translate");
    \u0275\u0275listener("click", function HeaderComponent_div_16_Template_button_click_57_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(67, "\n            ");
    \u0275\u0275element(68, "mat-divider");
    \u0275\u0275text(69, "\n            ");
    \u0275\u0275elementStart(70, "button", 16);
    \u0275\u0275pipe(71, "translate");
    \u0275\u0275listener("click", function HeaderComponent_div_16_Template_button_click_70_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(80, "\n            ");
    \u0275\u0275elementStart(81, "button", 16);
    \u0275\u0275pipe(82, "translate");
    \u0275\u0275listener("click", function HeaderComponent_div_16_Template_button_click_81_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const filterPlaylistMenu_r6 = \u0275\u0275reference(20);
    const addPlaylistMenu_r7 = \u0275\u0275reference(33);
    const ctx_r2 = \u0275\u0275nextContext();
    const pwaMenu_r8 = \u0275\u0275reference(20);
    \u0275\u0275advance(2);
    \u0275\u0275property("matMenuTriggerFor", addPlaylistMenu_r7)("matTooltip", \u0275\u0275pipeBind1(3, 17, "HOME.URL_UPLOAD.ADD_PLAYLIST"));
    \u0275\u0275advance(8);
    \u0275\u0275property("matMenuTriggerFor", filterPlaylistMenu_r6)("matTooltip", \u0275\u0275pipeBind1(11, 19, "HOME.FILTER_BY_TYPE"));
    \u0275\u0275advance(7);
    \u0275\u0275property("ngIf", ctx_r2.isElectron || ctx_r2.isTauri)("ngIfElse", pwaMenu_r8);
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(26, 21, "HOME.FILTER_BY_TYPE"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r2.playlistTypes);
    \u0275\u0275advance(7);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(36, 23, "HOME.TABS.FILE_UPLOAD"));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(43, 25, "HOME.TABS.FILE_UPLOAD"));
    \u0275\u0275advance(4);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(47, 27, "HOME.TABS.URL_UPLOAD"));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(54, 29, "HOME.TABS.URL_UPLOAD"));
    \u0275\u0275advance(4);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(58, 31, "HOME.TABS.TEXT_IMPORT"));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(65, 33, "HOME.TABS.TEXT_IMPORT"));
    \u0275\u0275advance(6);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(71, 35, "HOME.TABS.XTREME_IMPORT"));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(78, 37, "HOME.TABS.XTREME_IMPORT"));
    \u0275\u0275advance(4);
    \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(82, 39, "HOME.TABS.STALKER_PORTAL_IMPORT"));
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(89, 41, "HOME.TABS.STALKER_PORTAL_IMPORT"));
  }
}
...
function HeaderComponent_ng_template_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10, "\n        ");
    \u0275\u0275template(11, HeaderComponent_ng_template_19_ng_container_11_Template, 14, 6, "ng-container", 20);
    \u0275\u0275text(12, "\n        ");
    \u0275\u0275text(13, "\n    ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(14, "\n");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(10);
    \u0275\u0275property("ngIf", ctx_r2.isHome);
  }
}
function HeaderComponent_ngx_whats_new_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ngx-whats-new", 22);
...
var HeaderComponent = class _HeaderComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], inputs: { title: "title", subtitle: "subtitle" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 25, vars: 6, consts: [["pwaMenu", ""], ["filterPlaylistMenu", "matMenu"], ["addPlaylistMenu", "matMenu"], ["menu", "matMenu"], [1, "logo"], ["src", "./assets/icons/icon-tv-256.png", "height", "100"], [1, "main"], [1, "title"], [1, "subtitle"], ["class", "menu", 4, "ngIf"], [3, "items", "options", "closeModal", 4, "ngIf"], [1, "menu"], ["mat-icon-button", "", "data-test-id", "add-playlist", 1, "add-playlist-btn", 3, "matMenuTriggerFor", "matTooltip"], ["mat-icon-button", "", "data-test-id", "filter-playlist-by-type", 3, "matMenuTriggerFor", "matTooltip"], ["mat-icon-button", "", "data-test-id", "open-settings", 3, "matTooltip", "click", 4, "ngIf", "ngIfElse"], [1, "filter-container", 3, "click"], ["mat-menu-item", "", 3, "click"], ["mat-icon-button", "", "data-test-id", "open-settings", 3, "click", "matTooltip"], [3, "click", "change", "ngModelChange", "checked", "ngModel"], ["mat-icon-button", "", "data-test-id", "pwa-menu", 3, "matMenuTriggerFor"], [4, "ngIf"], ["mat-menu-item", "", "data-test-id", "pwa-open-settings", 3, "click"], [3, "closeModal", "items", "options"]], template: function HeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275text(15, "\n    ");
        \u0275\u0275template(16, HeaderComponent_div_16_Template, 93, 43, "div", 9);
        \u0275\u0275text(17, "\n");
        \u0275\u0275elementEnd();
        \u0275\u0275text(18, "\n\n");
