...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlaylistErrorViewComponent, { className: "PlaylistErrorViewComponent", filePath: "src\\app\\xtream\\playlist-error-view\\playlist-error-view.component.ts", lineNumber: 20 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CategoryContentViewComponent, { className: "CategoryContentViewComponent", filePath: "src\\app\\xtream\\category-content-view\\category-content-view.component.ts", lineNumber: 29 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CategoryViewComponent, { className: "CategoryViewComponent", filePath: "src\\app\\xtream\\category-view\\category-view.component.ts", lineNumber: 65 });
})();
...
function NavigationBarComponent_div_52_mat_icon_5_Template(rf, ctx) {
  if (rf & 1) {
...
function NavigationBarComponent_div_52_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function NavigationBarComponent_div_52_Template_div_click_0_listener() {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(4, "\n            ");
    \u0275\u0275template(5, NavigationBarComponent_div_52_mat_icon_5_Template, 2, 0, "mat-icon", 21);
    \u0275\u0275text(6, "\n        ");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function NavigationBarComponent_button_59_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 22);
    \u0275\u0275pipe(1, "translate");
    \u0275\u0275listener("click", function NavigationBarComponent_button_59_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext();
...
function NavigationBarComponent_div_62_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275nextContext();
    const sortPlaylistMenu_r9 = \u0275\u0275reference(68);
    \u0275\u0275advance(2);
    \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(3, 2, "CHANNELS.SORT_BY"))("matMenuTriggerFor", sortPlaylistMenu_r9);
  }
}
function NavigationBarComponent_div_64_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function NavigationBarComponent_div_64_Template_input_ngModelChange_7_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NavigationBarComponent, selectors: [["app-navigation-bar"]], inputs: { breadcrumbs: "breadcrumbs", contentType: "contentType", searchVisible: "searchVisible", sortVisible: "sortVisible", contentTypeNavigationItems: "contentTypeNavigationItems", clientSideSearch: "clientSideSearch", showCategories: "showCategories", activeLiveStream: "activeLiveStream", favoritesLiveStream$: "favoritesLiveStream$", favoriteVisible: "favoriteVisible" }, outputs: { contentTypeChanged: "contentTypeChanged", breadcrumbClicked: "breadcrumbClicked", favoritesClicked: "favoritesClicked", searchTextChanged: "searchTextChanged", addToFavoritesClicked: "addToFavoritesClicked", removeFromFavoritesClicked: "removeFromFavoritesClicked" }, standalone: true, features: [\u0275\u0275NgOnChangesFeature, \u0275\u0275StandaloneFeature], decls: 105, vars: 26, consts: [["sortPlaylistMenu", "matMenu"], ["id", "navigation"], ["mat-button", "", "routerLink", "/"], [1, "button-label"], ["name", "contentType", "aria-label", "Content Type", "hideSingleSelectionIndicator", "", 3, "value", "change", 4, "ngIf"], ["mat-button", "", 3, "click"], ["id", "sub-panel"], [1, "breadcrumbs"], [3, "click", 4, "ngFor", "ngForOf"], [1, "search-container"], [1, "favorite"], ["mat-icon-button", "", 3, "matTooltip", "click", 4, "ngIf"], ["class", "sort", 4, "ngIf"], ["class", "search", 4, "ngIf"], [3, "click"], ["mat-menu-item", "", 3, "click"], ["name", "contentType", "aria-label", "Content Type", "hideSingleSelectionIndicator", "", 3, "change", "value"], [3, "value", 4, "ngFor", "ngForOf", "ngForTrackBy"], [3, "value"], [1, "icon"], [1, "label"], [4, "ngIf"], ["mat-icon-button", "", 3, "click", "matTooltip"], [1, "sort"], ["mat-icon-button", "", "data-test-id", "sort-playlist", 3, "matTooltip", "matMenuTriggerFor"], [1, "search"], [1, "search-input"], ["matPrefix", ""], ["matInput", "", "placeholder", "Search by name", "type", "search", 3, "ngModelChange", "ngModel"]], template: function NavigationBarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275text(35, "\n\n        ");
        \u0275\u0275elementStart(36, "button", 5);
        \u0275\u0275listener("click", function NavigationBarComponent_Template_button_click_36_listener() {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275text(47, "\n");
        \u0275\u0275elementStart(48, "div", 6);
        \u0275\u0275text(49, "\n    ");
        \u0275\u0275elementStart(50, "div", 7);
        \u0275\u0275text(51, "\n        ");
        \u0275\u0275template(52, NavigationBarComponent_div_52_Template, 7, 2, "div", 8);
        \u0275\u0275text(53, "\n    ");
        \u0275\u0275elementEnd();
        \u0275\u0275text(54, "\n    ");
        ...
        \u0275\u0275text(58, "\n            ");
        \u0275\u0275template(59, NavigationBarComponent_button_59_Template, 6, 4, "button", 11);
        \u0275\u0275text(60, "\n        ");
        \u0275\u0275elementEnd();
        \u0275\u0275text(61, "\n        ");
        \u0275\u0275template(62, NavigationBarComponent_div_62_Template, 9, 4, "div", 12);
        \u0275\u0275text(63, "\n        ");
        \u0275\u0275template(64, NavigationBarComponent_div_64_Template, 10, 1, "div", 13);
        \u0275\u0275text(65, "\n    ");
        \u0275\u0275elementEnd();
        \u0275\u0275text(66, "\n    ");
        \u0275\u0275elementStart(67, "mat-menu", null, 0);
        \u0275\u0275text(69, "\n        ");
        \u0275\u0275elementStart(70, "section", 14);
        \u0275\u0275listener("click", function NavigationBarComponent_Template_section_click_70_listener($event) {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275text(91, "\n            ");
        \u0275\u0275elementStart(92, "button", 15);
        \u0275\u0275listener("click", function NavigationBarComponent_Template_button_click_92_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.setSortType("alpha"));
        });
        \u0275\u0275text(93, "\n                ");
        \u0275\u0275elementStart(94, "mat-icon");
        \u0275\u0275text(95, "sort_by_alpha");
        \u0275\u0275elementEnd();
        \u0275\u0275text(96, "\n                ");
      ...
      if (rf & 2) {
        \u0275\u0275advance(8);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 12, "PLAYLISTS"));
        \u0275\u0275advance(4);
        \u0275\u0275property("ngIf", ctx.showCategories);
        \u0275\u0275advance(10);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(23, 14, "Info"));
        \u0275\u0275advance(10);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(33, 16, "CHANNELS.FAVORITES"));
        \u0275\u0275advance(10);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(43, 18, "MENU.SETTINGS"));
        \u0275\u0275advance(10);
        ...
        \u0275\u0275advance(14);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(79, 20, "CHANNELS.SORT_BY_DATE"));
        \u0275\u0275advance(10);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(89, 22, "CHANNELS.SORT_BY_RATING"));
        \u0275\u0275advance(10);
        \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(99, 24, "CHANNELS.SORT_BY_NAME"));
      }
    }, dependencies: [
      FormsModule,
      DefaultValueAccessor,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NavigationBarComponent, { className: "NavigationBarComponent", filePath: "src\\app\\xtream\\navigation-bar\\navigation-bar.component.ts", lineNumber: 64 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VodDetailsComponent, { className: "VodDetailsComponent", filePath: "src\\app\\xtream\\vod-details\\vod-details.component.ts", lineNumber: 34 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PlayerDialogComponent, { className: "PlayerDialogComponent", filePath: "src\\app\\xtream\\player-dialog\\player-dialog.component.ts", lineNumber: 35 });
})();
