...
} from "./chunk-JGR4L5C6.js";
import {
  SearchResultsComponent
} from "./chunk-34TUATNE.js";
import "./chunk-RGESLAYI.js";
import {
  SettingsService,
  require_semver
  ...
  "package.json"(exports, module) {
    module.exports = {
      ...
      scripts: {
        ...
        serveProd: "ng serve -c production --proxy-config proxy.conf.json",
        test: "ng test",
        ...
        "build-winui": "ng build -c production --deploy-url /",
        tauri: "tauri"
      },
      dependencies: {
...
var xtreamRoutes = [
  {
    path: "xtreams/:id",
    loadComponent: () => import("./chunk-GRTGN5ZK.js").then((c) => c.XtreamShellComponent),
    children: [
      {
        path: "",
        redirectTo: "vod",
      ...
      {
        path: "live",
        loadComponent: () => import("./chunk-KN73DAWS.js").then((c) => c.LiveStreamLayoutComponent),
        children: [
          {
            path: ":categoryId",
            loadComponent: () => import("./chunk-KN73DAWS.js").then((c) => c.LiveStreamLayoutComponent)
      ...
      {
        path: "vod",
        loadComponent: () => import("./chunk-Q6SLNJYG.js").then((c) => c.XtreamMainContainerComponent),
        children: [
          {
            path: ":categoryId",
            loadComponent: () => import("./chunk-YVQ4THJX.js").then((c) => c.CategoryContentViewComponent)
          },
          {
            path: ":categoryId/:vodId",
            loadComponent: () => import("./chunk-PWPSX2JL.js").then((c) => c.VodDetailsComponent)
          }
        ]
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loadComponent: () => import("./chunk-PTJXJN2A.js").then((c) => c.SerialDetailsComponent)
          }
        ]
      },
      {
        path: "favorites",
        loadComponent: () => import("./chunk-HQ3VF3RQ.js").then((c) => c.FavoritesComponent)
      },
      {
        path: "recent",
        loadComponent: () => import("./chunk-VHXETGPH.js").then((c) => c.RecentlyViewedComponent)
      },
      {
        path: "search",
        loadComponent: () => import("./chunk-BSNJEC25.js").then((c) => c.SearchResultsComponent)
      }
    ]
  }
];
...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-ARVDE6RU.js").then((c) => c.HomeComponent)
  },
  {
    path: "playlists",
    loadComponent: () => import("./chunk-OXSKIO2U.js").then((c) => c.VideoPlayerComponent)
  },
  {
    path: "iptv",
    loadComponent: () => import("./chunk-OXSKIO2U.js").then((c) => c.VideoPlayerComponent)
  ...
  {
    path: "settings",
    loadComponent: () => import("./chunk-CGQABD6H.js").then((c) => c.SettingsComponent)
  },
  ...isTauri() ? xtreamRoutes : [
    {
      path: "xtreams/:id",
      loadComponent: () => import("./chunk-N457I232.js").then((c) => c.XtreamMainContainerComponent)
    }
  ],
  {
    path: "portals/:id",
    loadComponent: () => import("./chunk-5JRXTWC3.js").then((c) => c.StalkerMainContainerComponent)
  },
  {
    path: "**",
    redirectTo: ""
...
var AppComponent = class _AppComponent {
  constructor(dataService, dialog, epgService, ngZone, playlistService, router, store, snackBar, translate, settingsService, whatsNewService) {
  ...
  setRendererListeners() {
    this.commandsList.forEach((command) => {
      if (this.dataService.isElectron) {
        this.dataService.listenOn(command.id, () => this.ngZone.run((data) => command.callback(data)));
      } else {
        const cb = (response) => {
...
function fetch(input, init) {
  return __async(this, null, function* () {
    ...
    const abort = () => invoke("plugin:http|fetch_cancel", {
      rid
    });
    if (signal?.aborted) {
      abort();
    ...
    const {
      ...
      rid: responseRid
    } = yield invoke("plugin:http|fetch_send", {
      rid
    });
...
var TauriService = class _TauriService extends DataService {
  ...
  fetchFromUrl(payload) {
    return __async(this, null, function* () {
      try {
        const response = yield fetch(payload.url);
        const responseBody = yield response.text();
        const parsedPlaylist = (0, import_iptv_playlist_parser.parse)(responseBody);
        const playlist = createPlaylistObject("tests", parsedPlaylist, payload.url, "URL");
        window.postMessage({
          type: PLAYLIST_PARSE_RESPONSE,
  ...
  removeAllListeners(type) {
    console.error("Method not implemented. Following type was provided:", type);
  }
  ...
  fetchData(url, queryParams) {
    return __async(this, null, function* () {
      ...
      const response = yield fetch(urlObject.toString());
      if (!response.ok) {
        throw new Error(`Error: ${response.statusText} (Status: ${response.status})`);
      }
...
var isTauri3 = window && window.__TAURI__;
platformBrowser().bootstrapModule(AppModule, {
  preserveWhitespaces: false
}).then(() => {
  if (!isTauri3 && "serviceWorker" in navigator) {
